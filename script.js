...
const QUESTIONS = [
  { q: "Apa aktivitas yang paling dia suka lakukan di waktu senggang?", opts: ["Nonton/Streaming", "Olahraga/Outdoor", "Main game", "Baca/Belajar"] },
  { q: "Gaya kencan yang dia suka?", opts: ["Santai di kafe", "Petualangan/Travel", "Di rumah aja", "Acara formal"] },
  { q: "Tipe humor yang dia suka?", opts: ["Garing/Deadpan", "Gokil/Slapstick", "Cerdas/satire", "Romantis"] },
  { q: "Prioritas dalam pasangan?", opts: ["Setia & perhatian", "Ambisi & karier", "Santai & asyik", "Rapi & terencana"] },
  { q: "Lebih suka hadiah yang ...", opts: ["Berguna/praktis", "Mewah/berkelas", "DIY/personal", "Pengalaman (trip)"] },
  { q: "Media komunikasi favoritnya?", opts: ["Chat singkat", "Voice call", "Video call", "Tatap muka langsung"] },
  { q: "Seberapa sosial dia?", opts: ["Sangat sosial", "Pilih-pilih acara", "Introvert", "Hiburan kecil dengan teman dekat"] },
  { q: "Dalam konflik, dia cenderung ...", opts: ["Tenang & berdiskusi", "Butuh waktu sendiri", "Langsung berdebat", "Minta maaf duluan"] }
];
